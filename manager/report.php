...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini">PABX</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>PABX</b></span>
    </a>
            ...
            while($data = mysqli_fetch_array($result))
              { ?>
                ...
                <tr>
                  ...
                  <td><?php echo $data['ring_group'];?></td>
                  <td><?php echo $data['destination'];?></td>
                  <td><?php echo $data['src_channel'];?></td>
                  <td><?php echo $data['account_code'];?></td>
                  <td><?php echo $data['dst_channel'];?></td>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2017-2018 <a href="#!">Manusia Biasa</a>.</strong> All rights
    reserved.
  </footer>
